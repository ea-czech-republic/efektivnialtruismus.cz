...
class ProposalForm(forms.Form):
    ...
    organisation = forms.CharField(
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Your organisation"}
        )
    )
    title = forms.CharField(
        required=True,
        widget=forms.TextInput(
            attrs={"placeholder": "Thesis title", "class": "form-control"}
        ),
    )
    description = forms.CharField(
        required=True,
        widget=forms.Textarea(
            attrs={"class": "form-control", "placeholder": "Thesis description"}
        ),
    )
    ...
    why_important = forms.CharField(
        required=True,
        widget=forms.Textarea(
            attrs={"class": "form-control", "placeholder": "Why is it important?"}
        ),
    )

    sources = forms.CharField(
        widget=forms.Textarea(attrs={"class": "form-control", "placeholder": "Sources"})
    )
